...
RSpec.describe OpenSearch::Audit::Index do
  describe ".base_name" do
    subject { described_class.base_name(index_name) }

    {
      ".samplerr-2024" => ".samplerr",
      ".samplerr-2025.02" => ".samplerr",
      "dej418" => "dej418",
      "logs-2025-03-21" => "logs",
      "logs-2025.03.21" => "logs",
      "logs-2025.03.21.12" => "logs",
      "top_queries-2025.04.01-51422" => "top_queries"
